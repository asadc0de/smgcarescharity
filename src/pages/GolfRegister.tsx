...
const sponsorshipTiers = [
  ...
  { id: "awards", tier: "Awards Sponsor", price: "$1,500", perks: [] },
  { id: "photography", tier: "Photography Sponsor", price: "$1,250", perks: [] },
  { id: "locker", tier: "Locker Room Bar Sponsor", price: "$1,000", perks: [] },
  { id: "closest-pin", tier: "Closest to the Pin Sponsor", price: "$750", perks: [] },
  ...
  { id: "driving-range", tier: "Driving Range Sponsor", price: "$500", perks: [] },
