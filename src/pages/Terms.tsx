          ...
          >
            ...
            <div className="prose prose-lg prose-slate max-w-none text-muted-foreground space-y-12">
              ...
              <div className="p-8 bg-surface border border-border rounded-3xl mt-16">
                ...
                <a href="mailto:legal@smgcares.org" className="inline-flex items-center justify-center h-12 px-8 rounded-full bg-primary text-primary-foreground font-bold hover:bg-primary/90 transition-colors">
                  Contact Legal
                </a>
              </div>
