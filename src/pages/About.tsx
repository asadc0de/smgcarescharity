      ...
      <section className="container-x py-16 md:py-28">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto px-4 pb-12">
          {boardMembers.map((m, i) => (
            <div key={m.fullName + i} className="flex flex-col items-center justify-center text-center bg-white border border-border/50 shadow-sm rounded-2xl p-6 hover-lift">
